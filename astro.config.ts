...
export default defineConfig({
  ...
  image: {
    ...
    // Disable image optimization entirely: no sharp compression, resizing or
    // format conversion. Images (including remote `.ico` avatars) are served as-is.
